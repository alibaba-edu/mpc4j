...
public class GaloisTool {
     ...
     * @param result    result.
     */
    private void applyGalois(CoeffIterator operand, int galoisElt, Modulus modulus, CoeffIterator result) {
        assert operand != null;
        assert result != null;
     ...
     * @param result    result.
     */
    public void applyGalois(RnsIterator operand, int k, int galoisElt, Modulus[] modulus, RnsIterator result) {
        assert operand != result;
