 ...
 * UniformRandomGeneratorFactory in randomgen.h
 * </a>.
 *
...
public class UniformRandomGeneratorFactory {
    ...
    public UniformRandomGenerator create(PrngType prngType) {
        return switch (prngType) {
            // TODO: implement blake2xb and Shake256
            case BLAKE2XB, SHAKE256 -> throw new IllegalArgumentException("unsupported PRNG type");
            case SHA1PRNG -> new Sha1Prng();
