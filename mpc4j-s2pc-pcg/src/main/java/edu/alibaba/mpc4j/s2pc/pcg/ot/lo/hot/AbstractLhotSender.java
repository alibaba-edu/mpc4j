 ...
 * @date 2022/5/25
 */
public abstract class AbstractLhotSender extends AbstractSecureTwoPartyPto implements LhotSender {
    /**
     * 配置项
     */
    ...
    protected AbstractLhotSender(PtoDesc ptoDesc, Rpc senderRpc, Party receiverParty, LhotConfig config) {
