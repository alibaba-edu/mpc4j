 ...
 * @date 2022/07/26
 */
public class Np01BnotConfig implements BnotConfig {
    /**
     * 环境类型
     */
    ...
    private Np01BnotConfig(Builder builder) {
    ...
    public BnotFactory.BnotType getPtoType() {
        return BnotFactory.BnotType.NP01;
    }
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Np01BnotConfig> {
        /**
         * 环境类型
         */
        ...
        @Override
        public Np01BnotConfig build() {
            return new Np01BnotConfig(this);
        }
    }
}
