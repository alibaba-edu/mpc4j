...
/**
 * cache Zl multiplication triple generator sender.
 *
 * @author Weiran Liu
 * @date 2023/5/10
 */
public class CacheZlMtgSender extends AbstractZlMtgParty {
    /**
    ...
    public CacheZlMtgSender(Rpc senderRpc, Party receiverParty, CacheZlMtgConfig config) {
