 ...
 * @date 2022/07/25
 */
public class Co15BnotConfig implements BnotConfig {
    /**
     * 环境类型
     */
    ...
    private Co15BnotConfig(Builder builder) {
    ...
    public BnotFactory.BnotType getPtoType() {
        return BnotFactory.BnotType.CO15;
    }
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Co15BnotConfig> {
        /**
         * 环境类型
         */
        ...
        @Override
        public Co15BnotConfig build() {
            return new Co15BnotConfig(this);
        }
    }
}
