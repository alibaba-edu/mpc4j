...
/**
 * OOS17-2^l选1-HOT协议接收方。
 *
 * @author Weiran Liu
 * @date 2022/6/8
 */
public class Oos17LhotReceiver extends AbstractLhotReceiver {
    /**
     * COT协议发送方
     */
    ...
    public LotReceiverOutput receive(byte[][] choices) throws MpcAbortException {
        ...
        DataPacketHeader matrixHeader = new DataPacketHeader(
            taskId, getPtoDesc().getPtoId(), Oos17LhotPtoDesc.PtoStep.RECEIVER_SEND_MATRIX.ordinal(), extraInfo,
