...
public class ClientSetPmidTest {
    ...
    public void test2() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, 2, DEFAULT_MAX_SERVER_U, 2);
    }
    ...
    public void test10() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, 10, DEFAULT_MAX_SERVER_U, 10);
    }
    ...
    public void testSmallU() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, DEFAULT_SET_SIZE, SMALL_MAX_SERVER_U, DEFAULT_SET_SIZE);
    }
    ...
    public void testLargeServerSize() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, LARGE_SET_SIZE, DEFAULT_MAX_SERVER_U, DEFAULT_SET_SIZE);
    }
    ...
    public void testLargeClientSize() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, DEFAULT_SET_SIZE, DEFAULT_MAX_SERVER_U, LARGE_SET_SIZE);
    }
    ...
    public void testDefault() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, DEFAULT_SET_SIZE, DEFAULT_MAX_SERVER_U, DEFAULT_SET_SIZE);
    }
    ...
    public void testLarge() {
        PmidServer<String> server = PmidFactory.createServer(serverRpc, clientRpc.ownParty(), config);
        PmidClient<String> client = PmidFactory.createClient(clientRpc, serverRpc.ownParty(), config);
        testPmid(server, client, LARGE_SET_SIZE, DEFAULT_MAX_SERVER_U, LARGE_SET_SIZE);
    }
    ...
    private void testPmid(PmidServer<String> server, PmidClient<String> client,
                          int serverSetSize, int maxServerU, int clientSetSize) {
        ...
        try {
            ...
            // 构建线程
            ClientSetPmidServerThread serverThread = new ClientSetPmidServerThread(server, serverMap, maxServerU, clientSet.size());
            ClientSetPmidClientThread clientThread = new ClientSetPmidClientThread(client, clientSet,serverSet.size(),  maxServerU, serverU);
