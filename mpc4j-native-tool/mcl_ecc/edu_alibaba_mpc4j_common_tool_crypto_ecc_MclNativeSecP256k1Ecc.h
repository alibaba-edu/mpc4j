...
#include <jni.h>
/* Header for class edu_alibaba_mpc4j_common_tool_crypto_ecc_MclNativeSecP256k1Ecc */

#ifndef _Included_edu_alibaba_mpc4j_common_tool_crypto_ecc_MclNativeSecP256k1Ecc
#define _Included_edu_alibaba_mpc4j_common_tool_crypto_ecc_MclNativeSecP256k1Ecc
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     edu_alibaba_mpc4j_common_tool_crypto_ecc_MclNativeSecP256k1Ecc
 * Method:    init
 * Signature: ()V
 */
