 ...
 * @date 2024/2/23
 */
public class Cmg21jUpsiParams implements UpsiParams {
    /**
     * cuckoo hash type
     */
    ...
    private Cmg21jUpsiParams(CuckooHashBinType cuckooHashBinType, int binNum,
     ...
     * @return UPSI params.
     */
    public static Cmg21jUpsiParams uncheckCreate(CuckooHashBinType cuckooHashBinType, int binNum,
                                                 int maxPartitionSizePerBin, int itemEncodedSlotSize, int psLowDegree,
                                                 int[] queryPowers, long plainModulus, int polyModulusDegree,
                                                 int[] coeffModulusBits, int expectServerSize, int maxClientSize) {
        return new Cmg21jUpsiParams(
     ...
     * @return UPSI params.
     */
    public static Cmg21jUpsiParams create(CuckooHashBinType cuckooHashBinType, int binNum,
                                          int maxPartitionSizePerBin, int itemEncodedSlotSize, int psLowDegree,
                                          int[] queryPowers, long plainModulus, int polyModulusDegree,
                                          int[] coeffModulusBits, int expectServerSize, int maxClientSize) {
        Cmg21jUpsiParams cmg21UpsiParams = uncheckCreate(
            cuckooHashBinType, binNum, maxPartitionSizePerBin,
            itemEncodedSlotSize, psLowDegree, queryPowers,
            plainModulus, polyModulusDegree, coeffModulusBits,
            expectServerSize, maxClientSize
        );
        if (Cmg21jUpsiParamsChecker.checkValid(cmg21UpsiParams)) {
     ...
     */
    public static final Cmg21jUpsiParams SERVER_2K_CLIENT_MAX_1 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_100K_CLIENT_MAX_1 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_1K_CMP = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_1K_COM = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_11041 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_2K_CMP = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_2K_COM = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_256 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_4K_CMP = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_4K_COM = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_512_CMP = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_512_COM = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_5535 = Cmg21jUpsiParams.uncheckCreate(
    ...
    /**
     * serve size 1 million, max client size 65536.
     */
    public static final Cmg21jUpsiParams SERVER_1M_CLIENT_MAX_65536 = Cmg21jUpsiParams.uncheckCreate(
        CuckooHashBinType.NAIVE_3_HASH, 98304, 40,
        2,
        0, new int[]{1, 3, 4, 9, 11, 16, 17, 19, 20},
        34359410689L, 1 << 13, new int[]{50, 50, 50, 50},
        1000000, 65536
    );
     ...
     */
    public static final Cmg21jUpsiParams SERVER_16M_CLIENT_MAX_1024 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_16M_CLIENT_MAX_2048 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_16M_CLIENT_MAX_4096 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_16M_CLIENT_MAX_11041 = Cmg21jUpsiParams.uncheckCreate(
    ...
    /**
     * serve size 16 million, max client size 65536.
     */
    public static final Cmg21jUpsiParams SERVER_16M_CLIENT_MAX_65536 = Cmg21jUpsiParams.uncheckCreate(
        CuckooHashBinType.NAIVE_3_HASH, 98304, 98,
        2,
        8, new int[]{1, 3, 4, 9, 27},
        68718428161L, 1 << 14, new int[]{55, 50, 50, 50, 50},
        16000000, 65536
    );
     ...
     */
    public static final Cmg21jUpsiParams SERVER_256M_CLIENT_MAX_1024 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_256M_CLIENT_MAX_2048 = Cmg21jUpsiParams.uncheckCreate(
     ...
     */
    public static final Cmg21jUpsiParams SERVER_256M_CLIENT_MAX_4096 = Cmg21jUpsiParams.uncheckCreate(
