package edu.alibaba.mpc4j.common.rpc.test;
...
/**
 * abstract three-party protocol test.
 *
 * @author Weiran Liu
 * @date 2023/5/22
 */
public abstract class AbstractThreePartyPtoTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractThreePartyPtoTest.class);
    /**
     * the random status
     */
    ...
    public AbstractThreePartyPtoTest(String name) {
