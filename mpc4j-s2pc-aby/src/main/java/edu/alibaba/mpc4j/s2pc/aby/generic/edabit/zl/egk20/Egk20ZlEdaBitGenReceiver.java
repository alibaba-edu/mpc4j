 ...
 * @date 2023/5/19
 */
public class Egk20ZlEdaBitGenReceiver extends AbstractZlEdaBitGenParty {
    /**
     * Zl circuit receiver
     */
    ...
    public Egk20ZlEdaBitGenReceiver(Rpc receiverPpc, Party senderParty, Egk20ZlEdaBitGenConfig config) {
        super(Egk20ZlEdaBitGenPtoDesc.getInstance(), receiverPpc, senderParty, config);
    ...
    public Egk20ZlEdaBitGenReceiver(Rpc receiverPpc, Party senderParty, Party aiderParty, Egk20ZlEdaBitGenConfig config) {
        super(Egk20ZlEdaBitGenPtoDesc.getInstance(), receiverPpc, senderParty, config);
