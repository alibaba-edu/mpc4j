...
/**
 * Abstract Zl Greater Party.
 *
 * @author Li Peng
 * @date 2023/5/22
 */
public abstract class AbstractZlGreaterParty extends AbstractTwoPartyPto implements ZlGreaterParty {
    /**
     * max l
     */
    protected int maxL;
    ...
    public AbstractZlGreaterParty(PtoDesc ptoDesc, Rpc ownRpc, Party otherParty, ZlGreaterConfig config) {
