...
public interface Zp64 {
     ...
     * @return a是否为有效的群元素。
     */
    boolean validateElement(long a);
     ...
     * @return a是否为有效的域元素。
     */
    boolean validateNonZeroElement(long a);
     ...
     */
    boolean validateRangeElement(long a);
}
