 ...
 * @date 2022/8/24
 */
class Mbfk16SingleIndexPirNativeUtils {

    private Mbfk16SingleIndexPirNativeUtils() {
        // empty
    }
     ...
     */
    static native List<byte[]> generateReply(byte[] encryptionParams, List<byte[]> queryList, byte[][] database,
                                             int[] nvec);
