...
/**
 * SPAM client-specific preprocessing index PIR server.
 *
 * @author Weiran Liu
 * @date 2023/8/31
 */
public class SpamCpIdxPirServer extends AbstractCpIdxPirServer {
    /**
     * chunk size
     */
    ...
    public SpamCpIdxPirServer(Rpc serverRpc, Party clientParty, SpamCpIdxPirConfig config) {
        super(SpamCpIdxPirPtoDesc.getInstance(), serverRpc, clientParty, config);
    }
