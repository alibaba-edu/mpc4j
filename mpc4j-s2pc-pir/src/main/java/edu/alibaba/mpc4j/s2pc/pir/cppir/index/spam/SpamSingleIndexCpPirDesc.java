 ...
 * @date 2023/8/30
 */
class SpamSingleIndexCpPirDesc implements PtoDesc {
    /**
     * protocol ID
     */
     ...
     * the singleton mode
     */
    private static final SpamSingleIndexCpPirDesc INSTANCE = new SpamSingleIndexCpPirDesc();

    /**
     * private constructor.
     */
    private SpamSingleIndexCpPirDesc() {
        // empty
    }
