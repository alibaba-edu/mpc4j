 ...
 * @date 2023/8/25
 */
class PianoSingleIndexCpPirDesc implements PtoDesc {
    /**
     * protocol ID
     */
     ...
     * the singleton mode
     */
    private static final PianoSingleIndexCpPirDesc INSTANCE = new PianoSingleIndexCpPirDesc();

    /**
     * private constructor.
     */
    private PianoSingleIndexCpPirDesc() {
        // empty
    }
