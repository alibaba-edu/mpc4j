...
/**
 * SPAM client-specific preprocessing index PIR protocol description. The protocol is described in the following paper:
 * <p>
 ...
 * @date 2023/8/30
 */
class SpamCpIdxPirPtoDesc implements PtoDesc {
    /**
     * protocol ID
     */
     ...
     * protocol name
     */
    private static final String PTO_NAME = "SPAM_CP_IDX_PIR";
     ...
     * the singleton mode
     */
    private static final SpamCpIdxPirPtoDesc INSTANCE = new SpamCpIdxPirPtoDesc();

    /**
     * private constructor.
     */
    private SpamCpIdxPirPtoDesc() {
        // empty
    }
